package com.umutcansahin.unit1pathwat3ceyrekolusturma
...
import com.umutcansahin.unit1pathwat3ceyrekolusturma.ui.theme.Unit1Pathwat3CeyrekOlusturmaTheme

class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            Unit1Pathwat3CeyrekOlusturmaTheme {
